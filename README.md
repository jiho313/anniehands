...
### [1. **GitHub Actions와 AWS를 활용한 CI/CD 도입**](#1-github-actions와-aws를-활용한-cicd-도입)
...
### [2. **AOP 개념을 활용한 `@ControllerAdivce` 중앙집중식 예외 처리**](#2-aop-개념을-활용한-controlleradivce-중앙집중식-예외-처리)
...
### **3. 회원가입시 SMS 인증 번호를 세션 저장에서 Redis 도입 후 저장**
